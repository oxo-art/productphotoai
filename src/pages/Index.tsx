...
const Index = () => {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-blue-800 transition-all duration-1000`}>
      {/* Theme Mode Toggle */}
      ...
      <section className="relative overflow-hidden py-20 px-4">
        ...
        <div className={`absolute inset-0 bg-gradient-to-r from-blue-500/5 via-purple-500/10 to-cyan-500/5 opacity-20 blur-3xl transition-all duration-1000`}></div>
        <div className={`absolute top-10 left-10 w-72 h-72 bg-gradient-to-r from-blue-400/10 to-purple-400/10 opacity-30 rounded-full blur-3xl animate-pulse`}></div>
        <div className={`absolute bottom-10 right-10 w-96 h-96 bg-gradient-to-r from-purple-400/5 to-cyan-400/5 opacity-30 rounded-full blur-3xl animate-pulse delay-1000`}></div>
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <h2 className={`text-4xl md:text-6xl font-bold ${textStyles.primary} mb-6 leading-tight`}>
