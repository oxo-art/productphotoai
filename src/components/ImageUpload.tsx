      ...
      <Card className={`${getThemeStyle('card')} ${getThemeStyle('shadow')} transition-all duration-1000`}>
        <CardContent className="p-8">
          <div className="flex items-center gap-3 mb-6">
            <div className={`p-2 rounded-lg ${getThemeStyle('card')} transition-all duration-1000`}>
          ...
          {!uploadedImage ? (
            ...
            >
              <div className="relative">
                ...
                <div className={`absolute -top-2 -right-2 w-6 h-6 ${getThemeStyle('buttonPrimary')} rounded-full flex items-center justify-center transition-all duration-1000`}>
              ...
              <div className="flex flex-wrap gap-2">
                {promptSuggestions.map((suggestion, index) => (
                  <button
                    ...
                    className={`px-4 py-2 ${getThemeStyle('button')} ${textStyles.secondary} hover:${textStyles.primary} text-sm transition-all duration-200 hover:scale-105 border border-white/20 hover:border-white/30 rounded-lg`}
                  >
                    {suggestion}
                  </button>
                ))}
